...
$kategoria_slug   = 'druk-3d-na-zamowienie';
$ilosc_produktow  = 12;
    ...
    <div class="container-fluid pureshop-max-width">
        ...
        <div class="custom-cat-carousel-header">
            ...
            <div class="d-flex flex-direction-row gap-2 pureshop-mobile-new-line-arrow">
                <button type="button"
                        ...
                        id="customCatPrevdruk-3d-na-zamowienie"
                ...
                <button type="button"
                        ...
                        id="customCatNextdruk-3d-na-zamowienie"
        ...
        <?php if ($produkty_query->have_posts()) : ?>
            <div class="custom-cat-carousel-viewport">
                <div class="custom-cat-carousel-track" id="customCatTrackdruk-3d-na-zamowienie">
