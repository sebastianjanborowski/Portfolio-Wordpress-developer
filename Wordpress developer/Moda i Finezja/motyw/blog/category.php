...
<main class="container py-4">
  ...
  <h1 class="mb-4 advancedBlog_archive_title"><?php single_cat_title(); ?></h1>
    ...
    <div class="row g-4">
      ...
      <?php while ( have_posts() ) : the_post(); ?>
        <div class="col-12 col-md-6 col-lg-4">
          ...
          <article class="card h-100 shadow-sm advancedBlog_archive_resize">
            ...
            <div class="card-body d-flex flex-column advancedBlog_archive">
              ...
              <p class="card-text mb-4">
                <?php echo esc_html( wp_trim_words( get_the_excerpt(), 6, '...' ) ); ?>
              </p>
