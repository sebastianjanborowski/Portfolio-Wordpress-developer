<!-- =========================================================
         Moda premium
=========================================================-->
<section id="premiumModa" class="py-5 advancedBlog_marker_section">
    <div class="container">
        
    <a class="advancedBlog_permalink_to_archive" href="/category/moda-premium/">
      <h2 class="text-center fw-bold mb-4 advancedBlog_naglowek_h2 advancedBlog_marker_naglowki">Moda Premium</h2>
    </a>

      <?php
$modaPremium = new WP_Query([
  'post_type'           => 'post',
  'posts_per_page'      => 4,              // zmień ile chcesz
  'category_name'       => 'moda-premium',  // slug kategorii
  'post_status'         => 'publish',
  'ignore_sticky_posts' => true,
]);

if ( $modaPremium->have_posts() ) :
  $i = 0;
?>
    <div class="row">
<?php
  while ( $modaPremium->have_posts() ) : $modaPremium->the_post();
    $i++;
