<?php
// odpowiada za wyszukanie zamówienia po nazwie i przejście do akceptacji zamówienia
    ...
    <div class="container-fluid px-3 px-xl-4">
        <div class="diet-page-wide mx-auto">
            ...
            <div class="dashboard-header mb-4">
                ...
                <h1>Wyszukiwanie zamówienia do akceptacji</h1>
                <p>Podaj nazwę zamówienia cateringowego, aby przejść do akceptacji</p>
            </div>
            ...
            <div class="dashboard-card diet-form-card">
                ...
                <form id="catering_akcept_order" method="POST">
                    <div class="row g-3">
                        <div class="col-12">
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-between gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary diet-btn-save">
                            <i class="bi bi-search me-2"></i>Przejdź do akceptacji
                        </button>
                    </div>
                </form>
                ...
                <div class="dashboard-footer-info mt-4">
                    ...
                    <span><i class="bi bi-check-circle"></i> Akceptacja zamówienia przed realizacją</span>
                </div>
            </div>
