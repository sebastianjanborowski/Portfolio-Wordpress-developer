...
// oraz dokonanie edycji i zapisu do bazy danych
session_start();
    ...
    <div class="container-fluid px-3 px-xl-4">
        <div class="diet-page-wide mx-auto">
            ...
            <div class="dashboard-header mb-4">
                ...
                <h1>Wyszukiwanie użytkownika do edycji</h1>
                <p>Podaj login użytkownika, aby przejść do formularza edycji</p>
            </div>
            ...
            <div class="dashboard-card diet-form-card">
                ...
                <form id="catering_edit_user_form" method="POST">
                    <div class="row g-3">
                        <div class="col-12">
                ...
                <div class="dashboard-footer-info mt-4">
                    ...
                    <span><i class="bi bi-pencil-square"></i> Przejście do edycji po loginie</span>
                </div>
            </div>
