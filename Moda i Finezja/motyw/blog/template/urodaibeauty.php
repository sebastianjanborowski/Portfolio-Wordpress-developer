<!-- =========================================================
         Uroda i beauty
=========================================================-->
<section id="urodaibeauty" class="py-5 advancedBlog_marker_section">
    <div class="container">
        
    <a class="advancedBlog_permalink_to_archive" href="/category/uroda-i-beauty/">
      <h2 class="text-center fw-bold mb-4 advancedBlog_naglowek_h2 advancedBlog_marker_naglowki">Uroda i Beauty</h2>
    </a>

      <?php
$urodaIBeauty = new WP_Query([
  'post_type'           => 'post',
  'posts_per_page'      => 4,              // zmień ile chcesz
  'category_name'       => 'uroda-i-beauty',  // slug kategorii
  'post_status'         => 'publish',
  'ignore_sticky_posts' => true,
]);

if ( $urodaIBeauty->have_posts() ) :
  $i = 0;
?>
    <div class="row">
<?php
  while ( $urodaIBeauty->have_posts() ) : $urodaIBeauty->the_post();
    $i++;
