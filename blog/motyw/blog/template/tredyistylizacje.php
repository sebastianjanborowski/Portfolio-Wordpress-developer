<!-- =========================================================
         Trędy i stylizacje
=========================================================-->
<section id="tredyistylizacje" class="advancedBlog_marker_section">
    <div class="container">

  <a class="advancedBlog_permalink_to_archive" href="/category/trendy-i-stylizacje/">
    <h2 class="text-center fw-bold mb-4 advancedBlog_naglowek_h2 advancedBlog_marker_naglowki">Trędy i Stylizacje</h2>
  </a>


      <?php
$tredyIStylizacje = new WP_Query([
  'post_type'           => 'post',
  'posts_per_page'      => 4,              // zmień ile chcesz
  'category_name'       => 'trendy-i-stylizacje',  // slug kategorii
  'post_status'         => 'publish',
...
?>
    <div class="row">
<?php
if ( $tredyIStylizacje->have_posts() ) :
  $i = 0;

  while ( $tredyIStylizacje->have_posts() ) : $tredyIStylizacje->the_post();
    $i++;
    ...
    $title_zajawka = wp_html_excerpt( wp_strip_all_tags($title_zajawka), 40,'...'); 
