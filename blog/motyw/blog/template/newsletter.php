<!-- =========================================================
         Newsletter
=========================================================-->
<section id="newsletter" class="py-5 advancedBlog_marker_section">
    <div class="container">
        
    <a class="advancedBlog_permalink_to_archive" href="/category/newsletter-modowy/">
      <h2 class="text-center fw-bold mb-4 advancedBlog_naglowek_h2 advancedBlog_marker_naglowki">Newsletter modowy</h2>
    </a>

      <?php
$newsletter = new WP_Query([
  'post_type'           => 'post',
  'posts_per_page'      => 2,              // zmień ile chcesz
  'category_name'       => 'newsletter-modowy',  // slug kategorii
  'post_status'         => 'publish',
