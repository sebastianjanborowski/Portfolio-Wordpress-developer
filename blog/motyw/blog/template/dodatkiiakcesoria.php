<!-- =========================================================
         Dodatki i akcesoria
=========================================================-->
<section id="dodatkiiakcesoria" class="py-5 advancedBlog_marker_section">
    <div class="container">
        
    <a class="advancedBlog_permalink_to_archive" href="/category/dodatki-i-akcesoria/">
      <h2 class="text-center fw-bold mb-4 advancedBlog_naglowek_h2 advancedBlog_marker_naglowki">Dodatki i Akcesoria</h2>
    </a>

      <?php
$dodatkiIAkcesoria = new WP_Query([
  'post_type'           => 'post',
  'posts_per_page'      => 4,              // zmień ile chcesz
  'category_name'       => 'dodatki-i-akcesoria',  // slug kategorii
  'post_status'         => 'publish',
  'ignore_sticky_posts' => true,
]);

if ( $dodatkiIAkcesoria->have_posts() ) :
  $i = 0;
?>
    <div class="row">
<?php
  while ( $dodatkiIAkcesoria->have_posts() ) : $dodatkiIAkcesoria->the_post();
    $i++;
