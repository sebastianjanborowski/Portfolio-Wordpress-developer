...
<main class="container py-4">
  ...
  <h1 class="mb-4 advancedBlog_wcag_light_color">Dodatki i Akcesoria</h1>
      ...
      <?php while ( have_posts() ) : the_post(); ?>
        <div class="col-12 col-md-6 col-lg-4">
          ...
          <article class="card h-100 shadow-sm advancedBlog_dark_bgc_light_content">
            ...
            <div class="card-body d-flex flex-column blog-category-marker-zajawka">
              ...
              <p class="card-text mb-4">
                <?php echo esc_html( wp_trim_words( get_the_excerpt(), 2, '...' ) ); ?>
              </p>
