    ...
    <div class="container-fluid">
        <div class="dashboard-wrapper">
            ...
            <section class="dashboard-header">
                ...
                <h1>Wybierz raport do generowania</h1>
            ...
            <section class="dashboard-card">
                <div class="row dashboard-grid justify-content-center">
                    ...
                    <div class="col-12 col-md-6 col-xl-4">
                        <a href="generate_raport_users.php" class="dashboard-tile">
                    ...
                    <div class="col-12 col-md-6 col-xl-4">
                        <a href="generate_raport_logowanie_users.php" class="dashboard-tile">
                            <div class="dashboard-tile-icon">
                                <i class="bi bi-people"></i>
                            </div>
                            <div class="dashboard-tile-content">
                    ...
                    <!-- Posiłki -->
                    <div class="col-12 col-md-6 col-xl-4">
                        <a href="generate_raport_diet.php" class="dashboard-tile">
                            <div class="dashboard-tile-icon">
                    ...
                    <!-- Zamówienia -->
                    <div class="col-12 col-md-6 col-xl-4">
                        <a href="generate_raport_orders.php" class="dashboard-tile">
                            <div class="dashboard-tile-icon">
