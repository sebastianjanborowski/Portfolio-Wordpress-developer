<?php
// odpowiada za wyszukanie danych po loginie użytkownika i zwrócenie ich z użyciem js na ekran
// oraz dokonanie usunięcia użytkownika z bazy danych
session_start();
    ...
    <div class="container-fluid px-3 px-xl-4">
        <div class="diet-page-wide mx-auto">
            ...
            <div class="dashboard-header mb-4">
                ...
                <h1>Wyszukiwanie użytkownika do usunięcia</h1>
                <p>Podaj login użytkownika, aby przejść do formularza kasowania</p>
            </div>
            ...
            <div class="dashboard-card diet-form-card">
                ...
                <form id="catering_delete_user_form" method="POST">
                    <div class="row g-3">
                        <div class="col-12">
                ...
                <div class="dashboard-footer-info mt-4">
                    ...
                    <span><i class="bi bi-trash"></i> Przejście do kasowania po loginie</span>
                </div>
            </div>
