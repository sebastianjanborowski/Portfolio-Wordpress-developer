<?php
// odpowiada za wyszukanie danych po nazwie diety i zwrócenie ich z uzyciem js na ekran i dokonanie edycji i zapis do bazy danych
session_start();
    ...
    <div class="container-fluid px-3 px-xl-4">
        <div class="diet-page-wide mx-auto">
            ...
            <div class="dashboard-header mb-4">
                ...
                <h1>Wyszukiwanie diety do edycji</h1>
                <p>Podaj identyfikator diety, aby przejść do formularza edycji</p>
            </div>
            ...
            <div class="dashboard-card diet-form-card">
                ...
                <form id="catering_edit_diet_form" method="POST">
                    <div class="row g-3">
                        <div class="col-12">
                            <label for="diet_id" class="form-label-custom">Kod diety</label>
                            <input
                                type="text"
                                name="diet_name"
                                id="diet_name_find"
                ...
                <div class="dashboard-footer-info mt-4">
                    ...
                    <span><i class="bi bi-pencil-square"></i> Przejście do edycji po ID</span>
                </div>
