<?php
    ...
    $pageScript = 'leave-request-update.js';
?>
        ...
        <div class="container">
            <section id="header" class="app-hero">
                <div class="app-hero-card">
                    ...
                    <h1 class="app-title">Aktualizuj wniosek o urlop</h1>
                    <p class="app-subtitle">Podaj ID wniosku oraz nowe dane. Komunikat po aktualizacji pojawi się pod formularzem.</p>
                </div>
            </section>
            ...
            <section id="form" class="app-card">
                    ...
                    <div class="mb-3 text-start">
                        <label for="Id" class="form-label">ID wniosku do aktualizacji</label>
                        <input 
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <input 
                            ...
                            type="number" 
                            name="Employee" 
                            placeholder="Wpisz ID pracownika"
                    ...
                    <div class="mb-3 text-start">
                        ...
                        >
                        <div class="form-text">Określ aktualny status wniosku.</div>
                    </div>

                <button type="button" id="leaveUpdateSubmitButton" class="btn btn-primary mt-2">
                    Aktualizuj wniosek
                </button>
