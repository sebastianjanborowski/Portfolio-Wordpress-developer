        ...
        <div class="container">
            <section id="header" class="app-hero">
                <div class="app-hero-card">
                    ...
                    <h1 class="app-title">Aktualizuj projekt</h1>
                    <p class="app-subtitle">Podaj ID projektu oraz nowe dane. Komunikat po aktualizacji pojawi się pod formularzem.</p>
                </div>
            </section>
            ...
            <section id="form" class="app-card">
                    ...
                    <div class="mb-3 text-start">
                        <label for="Id" class="form-label">ID projektu do aktualizacji</label>
                        <input 
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <input 
                            ...
                            type="text" 
                            name="Project_Type" 
                            placeholder="Wpisz typ projektu"

                        >
                        <div class="form-text">Podaj aktualną nazwę albo rodzaj projektu.</div>
                    </div>
                    ...
                    <div class="mb-3 text-start">
                        ...
                        >
                        <div class="form-text">Wybierz aktualną datę rozpoczęcia.</div>
                    </div>
                    ...
                    <div class="mb-3 text-start">
                        ...
                        >
                        <div class="form-text">Wybierz aktualną datę zakończenia.</div>
                    </div>
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <input 
                            ...
                            placeholder="Wpisz ID kierownika"
                ...
                <button type="button" id="projectUpdateSubmitButton" class="btn btn-primary mt-2">
                    Aktualizuj projekt
                </button>
