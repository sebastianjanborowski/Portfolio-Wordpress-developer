        ...
        <div class="container">
            <section id="header" class="app-hero">
                <div class="app-hero-card">
                    ...
                    <h1 class="app-title">Usuń pracownika</h1>
                    <p class="app-subtitle">Podaj ID pracownika, którego chcesz usunąć. Komunikat pojawi się pod formularzem.</p>
                </div>
            </section>
            ...
            <section id="form" class="app-card">
                    ...
                    <div class="mb-3 text-start">
                        <label for="Id" class="form-label">ID pracownika do usunięcia</label>
                        <input 
                        ...
                        >
                        <div class="form-text">Podaj ID rekordu z tabeli pracowników.</div>
                    </div>

                <button type="button" id="employeeDeleteSubmitButton" class="btn btn-primary mt-2">
                    Usuń pracownika
                </button>
